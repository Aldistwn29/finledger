...
export function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) { return <div className={cn("rounded-3xl border bg-card text-card-foreground shadow-[0_8px_24px_-12px_color-mix(in_srgb,var(--primary)_22%,transparent)]", className)} {...props} />; }
